...
router.post(
  ...
  [
    ...
    check("name")
      .notEmpty()
      .withMessage("El nombre de la inversión es obligatorio"),
    check("symbol")
      .notEmpty()
      .withMessage("El símbolo de la inversión es obligatorio"),
...
router.get("/search", authenticateJWT, investmentController.searchSymbol);
router.delete(
  "/delete/:investmentId",
  authenticateJWT,
